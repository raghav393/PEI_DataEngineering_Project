...
import shutil
tmp_filename = "/tmp/test_cleansing.py"
tmp_dir = "/tmp"
...
shutil.copy("test_cleansing.py", "/tmp/test_cleansing.py")
...
import sys
sys.modules.pop("test_cleansing", None)
...
pytest.main(["/tmp/test_cleansing.py", "-v", "-s", "--cache-clear"])