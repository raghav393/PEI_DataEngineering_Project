...
class data_ingest:
    ...
    #Function to load execution configuration file
    ...
    #Function will cleanse the column names
    ...
    #Function to read data from source files
    ...
    #Function to write data into delta tables
...
#Function to merge delta tables
